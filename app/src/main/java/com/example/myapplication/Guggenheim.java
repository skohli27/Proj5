...
public class Guggenheim extends Museum{
    ...
    private static final double SENIOR_PRICE = 17;
    private static final double STUDENT_PRICE = 12;



    public Guggenheim(String name, int image, String url){
